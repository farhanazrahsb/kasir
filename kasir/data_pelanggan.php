                ...
                <div class="navbar-default sidebar" role="navigation">
                    <div class="sidebar-nav navbar-collapse">
                        <ul class="nav" id="side-menu">
                            ...
                            <li>
                                <a href="data_pelanggan.php" class="active"><i class="fa fa-archive fa-fw"></i> Data Pelanggan</a>
                            </li>
                        </ul>
                    </div>
                </div>
                                    ...
                                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><?php echo "<a class='glyphicon glyphicon-edit' title='Edit' href='updatepelanggan.php?no=$var[no]'></a> |<a class='glyphicon glyphicon-trash' title='Hapus' href='deletepelanggan.php?no=$var[no]'></a>"; ?></td>
                                            </tr>
                                        <?php
                                          $no++;
                                          }
