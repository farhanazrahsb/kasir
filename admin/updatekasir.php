...
if(isset($_GET['no']))
{
 $sql_query="SELECT * FROM kasir WHERE no=".$_GET['no'];
...
$email          = $_POST['email'];
 ...
 $sql_query = "UPDATE kasir SET id_kasir='$id_kasir', nama='$nama', username='$username', password='$password', email='$email' WHERE no=".$_GET['no'];
 // sql query for update data into database
 ...
 if(mysql_query($sql_query))
 {
  ...
  window.location.href='data_kasir.php';
  </script>
  <?php
 }
 else
