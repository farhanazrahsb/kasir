                                ...
                                <div class="dataTable_wrapper">
                                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                        ...
                                        ?>
                                            <tr>
                                                <td><?php echo $no ?></td>
                                                <td><?php echo $var ['kd_pegawai']; ?></td>
                                                <td><?php echo $var ['nama']; ?></td>
                                                <td><?php echo $var ['no_hp']; ?></td>
                                                <td><?php echo $var ['alamat']; ?></td>
                                                <td><?php echo "<a class='glyphicon glyphicon-edit' title='Edit' href='updatepegawai.php?no=$var[no]'></a> |<a class='glyphicon glyphicon-trash' title='Hapus' href='deletepegawai.php?no=$var[no]'></a>"; ?></td>
                                            </tr>
                                        <?php
                                          $no++;
                                          }
