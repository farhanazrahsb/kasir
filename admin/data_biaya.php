                                ...
                                <div class="dataTable_wrapper">
                                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                        ...
                                        ?>
                                            <tr>
                                                <td><?php echo $no ?></td>
                                                <td><?php echo $var ['id_kend']; ?></td>
                                                <td><?php echo $var ['jenis_kend']; ?></td>
                                                <td><?php echo $var ['harga']; ?></td>
                                                <td><?php echo "<a class='glyphicon glyphicon-edit' title='Edit' href='updatebiaya.php?no=$var[no]'></a> |<a class='glyphicon glyphicon-trash' title='Hapus' href='deletebiaya.php?no=$var[no]'></a>"; ?></td>
                                            </tr>
                                        <?php
                                          $no++;
                                          }
