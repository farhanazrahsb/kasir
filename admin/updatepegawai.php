...
if(isset($_GET['no']))
{
 $sql_query="SELECT * FROM pegawai WHERE no=".$_GET['no'];
...
$alamat         = $_POST['alamat'];
 ...
 $sql_query = "UPDATE pegawai SET kd_pegawai='$kd_pegawai', nama='$nama', no_hp='$no_hp', alamat='$alamat' WHERE no=".$_GET['no'];
 // sql query for update data into database
                        ...
                        <ul class="nav" id="side-menu">
                            ...
                            <li>
                                ...
                                <ul class="nav nav-second-level">
                                    ...
                                    <li>
                                        <a href="data_pegawai.php" class="active">Data Pegawai</a>
                                    </li>
                                    <li>
                                    ...
                                    <div class="col-lg-6">
                                        <form method="post">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="kd_pegawai" placeholder="ID Pegawai" value="<?php echo $row['kd_pegawai']; ?>" readonly>
                                            </div>
                                            <div class="form-group">
                                                <label>Nama</label>
