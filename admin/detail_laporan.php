                                ...
                                <div class="dataTable_wrapper">
                                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                        ...
                                        <?php
                                          ...
                                          $query = mysql_query ("SELECT * FROM laporan order by tgl desc");
                                          $no=1;
                                          while ($var=mysql_fetch_array($query)) {
                                            $namapegawai=mysql_fetch_array(mysql_query("SELECT nama FROM pegawai WHERE kd_pegawai='$var[kd_pegawai]'"));
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td align="center"><?php echo "<a class='glyphicon glyphicon-trash' title='Hapus' href='deletelaporan.php?no=$var[no]'></a>"; ?></td>
                                            </tr>
                                        <?php
                                          $no++;
                                          }
