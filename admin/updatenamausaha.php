...
if(isset($_GET['no']))
{
 $sql_query="SELECT * FROM nama_usaha WHERE no=".$_GET['no'];
...
$nama           = $_POST['nama'];
 ...
 $sql_query = "UPDATE nama_usaha SET nama='$nama' WHERE no=".$_GET['no'];
 // sql query for update data into database
 ...
 if(mysql_query($sql_query))
 {
  ...
  window.location.href='nama_usaha.php';
  </script>
  <?php
 }
 else
...
{
 header("Location: nama_usaha.php");
}
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <body>
        ...
        <div id="wrapper">
                ...
                <div class="navbar-default sidebar" role="navigation">
                    <div class="sidebar-nav navbar-collapse">
                        <ul class="nav" id="side-menu">
                            ...
                            <li>
                                <a href="nama_usaha.php" class="active"><i class="fa fa-home fa-fw"></i> Nama Usaha</a>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Nama Usaha</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <form method="post">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="nama" placeholder="Nama Usaha" value="<?php echo $row['nama']; ?>">
                                            </div>
