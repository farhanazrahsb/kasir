                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                $min_tanggal=mysql_fetch_array(mysql_query("select min(tgl) as min_tanggal from transaksi"));
                                $max_tanggal=mysql_fetch_array(mysql_query("select max(tgl) as max_tanggal from transaksi"));
                                ?>
                                        <form action="cari_lap_pendapatan.php" method="post" name="postform">
                                        <div class="col-lg-6">
