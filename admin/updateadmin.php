...
$email          = $_POST['email'];
 ...
 $sql_query = "UPDATE admin SET id_admin='$id_admin', nama='$nama', username='$username', password='$password', email='$email' WHERE no=".$_GET['no'];
 // sql query for update data into database
                        ...
                        <ul class="nav" id="side-menu">
                            ...
                            <li>
                                ...
                                <ul class="nav nav-second-level">
                                    ...
                                    <li>
                                        <a href="data_admin.php" class="active">Data Admin</a>
                                    </li>
                                </ul>
                                <!-- /.nav-second-level -->
                            </li>
                                    ...
                                    <div class="col-lg-6">
                                        <form method="post">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="id_admin" placeholder="ID Admin" value="<?php echo $row['id_admin']; ?>" readonly>
                                            </div>
                                            <div class="form-group">
                                                <label>Nama</label>
