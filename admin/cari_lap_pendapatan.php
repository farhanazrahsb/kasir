                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <a class="btn btn-info" onclick="self.history.back()"> <span class="fa fa-arrow-left" title="Kembali"></span></a> Laporan Pendapatan
                            </div>
                                ...
                                <div class="row">
                                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                        ...
                                        <script language="JavaScript">
                                            alert('Tanggal Awal, Tanggal Akhir Harap di Isi!');
                                            document.location='laporan_pendapatan.php';
                                        </script>
                                        ...
                                        <?php
                                        $query=mysql_query("select * from transaksi where tgl between '$awal' and '$akhir'");
                                        }
                                        ?>
                                        <?php
                                        ...
                                        <tfoot>
                                            ...
                                            <tr>
                                                <td><?php
                                                $jumlahkan = "SELECT SUM(harga) AS jumlah_total FROM transaksi where tgl between '$awal' and '$akhir'"; //perintah untuk menjumlahkan
