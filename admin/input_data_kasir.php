                        ...
                        <ul class="nav" id="side-menu">
                            ...
                            <li>
                                ...
                                <ul class="nav nav-second-level">
                                    ...
                                    <li>
                                        <a href="input_data_kasir.php" class="active">Input Data Kasir</a>
                                    </li>
                                    <li>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    ...
                                    include '../koneksi/koneksi.php';
                                    // membuat query max
                                      $carikode = mysql_query("select max(id_kasir) from kasir") or die (mysql_error());
                                      // menjadikannya array
                                    ...
                                    echo'
                                        <form method="post" enctype="multipart/form-data">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="id_kasir" placeholder="ID Kasir" value="'.$kode_otomatis.'" readonly>
                                            </div>
                                            <div class="form-group">
                                                <label>Nama</label>
                                        ...
                                        $query = mysql_query("INSERT INTO kasir (id_kasir, nama, username, password, email) VALUES ('$_POST[id_kasir]', '$_POST[nama]', '$_POST[username]', '$_POST[password]', '$_POST[email]')");

                                        if ($query){
                                        echo "<script>alert('Berhasil Menginput')</script>";
                                        echo "<meta http-equiv='refresh' content='1 url=input_data_kasir.php'>";
                                        }else{
