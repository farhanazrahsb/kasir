                                ...
                                <div class="row">
                                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                        ...
                                        <tfoot>
                                            ...
                                            <tr>
                                                <td><?php
                                                $jumlahkan = "SELECT SUM(5000) AS jumlah_total FROM laporan where kd_pegawai like '%$kd_pegawai%' and id_kend like '%$id_kend%' and tgl between '$awal' and '$akhir'"; //perintah untuk menjumlahkan
